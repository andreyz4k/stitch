...
fn write_json_for_diff(out: &Value, expected_out_path: &str) {
    let path = format!(
        "out/test_outputs/{}_{}.json",
        timestamp(),
        Path::new(expected_out_path)
            .file_stem()
            .unwrap()
            .to_str()
            .unwrap()
...
fn compare_out_jsons(file: &str, expected_out_file: &str, args: &str, input_format: InputFormat) {
    let input = input_format
        .load_programs_and_tasks(std::path::Path::new(file))
        .unwrap();

    let mut cfg =
        MultistepCompressionConfig::parse_from(format!("compress {args}").split_whitespace());
    ...
    let expected_output: Value = serde_json::from_str(
        &std::fs::read_to_string(std::path::Path::new(expected_out_file)).unwrap(),
    )
    .unwrap();
    ...
    check_eq(
        &output["original_cost"],
        &expected_output["original_cost"],
        vec!["original_cost".into()],
        &output,
        expected_out_file,
    );
    check_eq(
    ...
    check_eq(
        ...
        &expected_output["compression_ratio"],
        vec!["compression_ratio".into()],
        &output,
        expected_out_file,
    );
    check_eq(
        &output["num_abstractions"],
        &expected_output["num_abstractions"],
        vec!["num_abstractions".into()],
        &output,
        expected_out_file,
    );
    check_eq(
        &output["abstractions"],
        &expected_output["abstractions"],
        vec!["abstractions".into()],
        &output,
        expected_out_file,
    );
    check_eq(
...
fn check_eq(
    ...
    match (actual, expected) {
        ...
        _ => {
            write_json_for_diff(out, expected_out_path);
            panic!(
                "mismatch between types in json at {}:\nactual:  {}\nexpected:{}\n",
                path.join("."),
                actual,
                expected
            );
...
fn simple1_a1_i1() {
    compare_out_jsons(
        "data/basic/simple1.json",
        "data/expected_outputs/simple1-a1-i1.json",
        "-i1 -a1 --rewrite-check",
...
fn simple2_a1_i1() {
    compare_out_jsons(
        "data/basic/simple2.json",
        "data/expected_outputs/simple2-a1-i1.json",
        "-i1 -a1 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple3_a1_i1() {
    compare_out_jsons(
        "data/basic/simple3.json",
        "data/expected_outputs/simple3-a1-i1.json",
        "-i1 -a1 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple4_a1_i1() {
    compare_out_jsons(
        "data/basic/simple4.json",
        "data/expected_outputs/simple4-a1-i1.json",
        "-i1 -a1 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple5_a1_i1() {
    compare_out_jsons(
        "data/basic/simple5.json",
        "data/expected_outputs/simple5-a1-i1.json",
        "-i1 -a1 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple6_a2_i1() {
    compare_out_jsons(
        "data/basic/simple6.json",
        "data/expected_outputs/simple6-a2-i1.json",
        "-i1 -a2 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple6_a1_i1() {
    compare_out_jsons(
        "data/basic/simple6.json",
        "data/expected_outputs/simple6-a1-i1.json",
        "-i1 -a1 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple7_a2_i1() {
    compare_out_jsons(
        "data/basic/simple7.json",
        "data/expected_outputs/simple7-a2-i1.json",
        "-i1 -a2 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple9_a2_i1() {
    compare_out_jsons(
        "data/basic/simple9.json",
        "data/expected_outputs/simple9-a2-i1.json",
        "-i1 -a2 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple9_a1_i1() {
    compare_out_jsons(
        "data/basic/simple9.json",
        "data/expected_outputs/simple9-a1-i1.json",
        "-i1 -a1 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple10_a2_i1() {
    compare_out_jsons(
        "data/basic/simple10.json",
        "data/expected_outputs/simple10-a2-i1.json",
        "-i1 -a2 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn simple11_a2_i1() {
    compare_out_jsons(
        "data/basic/simple11.json",
        "data/expected_outputs/simple11-a2-i1.json",
        "-i1 -a2 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn nuts_bolts_a3_i10() {
    compare_out_jsons(
        ...
        "data/expected_outputs/nuts-bolts-a3-i10.json",
...
fn furniture_a2_i10() {
    compare_out_jsons(
        ...
        "data/expected_outputs/furniture-a2-i10.json",
        "-i10 -a2 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
#[test]
fn wheels_a2_i10() {
    compare_out_jsons(
        ...
        "data/expected_outputs/wheels-a2-i10.json",
        "-i10 -a2 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn dials_a2_i10() {
    compare_out_jsons(
        ...
        "data/expected_outputs/dials-a2-i10.json",
        "-i10 -a2 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn city_a1_i1() {
    compare_out_jsons(
        ...
        "data/expected_outputs/city-a1-i1.json",
        "-i1 -a1 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn bridge_a2_i10() {
    compare_out_jsons(
        ...
        "data/expected_outputs/bridge-a2-i10.json",
        "-i10 -a2 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn castle_a1_i1() {
    compare_out_jsons(
        ...
        "data/expected_outputs/castle-a1-i1.json",
        "-i1 -a1 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn house_a1_i1() {
    compare_out_jsons(
        ...
        "data/expected_outputs/house-a1-i1.json",
        "-i1 -a1 --rewrite-check",
        InputFormat::ProgramsList,
    );
}
...
fn logo_iteration_1_a3_i10() {
    compare_out_jsons(
        "data/dc/logo_iteration_1.json",
        "data/expected_outputs/logo_iteration_1-a3-i10.json",
        "-i10 -a3 --rewrite-check",
...
fn origami_0_a3_i10() {
    compare_out_jsons(
        "data/dc/origami/iteration_0_3.json",
        "data/expected_outputs/origami_0-a3-i10.json",
        "-i10 -a3 --rewrite-check",
        InputFormat::Dreamcoder,
    );
}
...
fn origami_1_a3_i10() {
    compare_out_jsons(
        "data/dc/origami/iteration_1_6.json",
        "data/expected_outputs/origami_1-a3-i10.json",
        "-i10 -a3 --rewrite-check",
        InputFormat::Dreamcoder,
    );
}
...
fn origami_2_a3_i10() {
    compare_out_jsons(
        "data/dc/origami/iteration_2_1.json",
        "data/expected_outputs/origami_2-a3-i10.json",
        "-i10 -a3 --rewrite-check",
        InputFormat::Dreamcoder,
    );
}
...
fn neurosym_match_at_tag() {
    compare_out_jsons(
        ...
        "data/expected_outputs/neurosym_match_at_tag.json",
        "",
        InputFormat::ProgramsList,
    );
    compare_out_jsons(
        "data/neurosym/match_at_tag.json",
        "data/expected_outputs/neurosym_match_at_tag_excluded.json",
        "--fused-lambda-tags 2",
        InputFormat::ProgramsList,
    );
}
...
fn neurosym_metavariable_with_tag() {
    compare_out_jsons(
        "data/neurosym/metavariable_with_tag.json",
        "data/expected_outputs/neurosym_metavariable_with_tag.json",
        "",
        InputFormat::ProgramsList,
    );
    compare_out_jsons(
        "data/neurosym/metavariable_with_tag.json",
        "data/expected_outputs/neurosym_metavariable_with_tag_excluded.json",
        "--fused-lambda-tags 2",
        InputFormat::ProgramsList,
    );
}
